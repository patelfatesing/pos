...
Route::get('/dashboard/chart/income-expense-financial-chart', [DashboardController::class, 'incomeExpenseFinancialChart']);
Route::get('/dashboard/chart/pie-chart', [DashboardController::class, 'pieChart']);
Route::get('/dashboard/ajax/top-worst-products', [DashboardController::class, 'ajaxTopAndWorstProducts'])->name('dashboard.ajax.top-worst-products');
Route::get('/dashboard/chart/revenue-vs-cost', [DashboardController::class, 'revenueVsCostChart']);
