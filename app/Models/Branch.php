...
class Branch extends Model
{
    ...
    protected $fillable = ['name', 'address', 'description', 'is_active', 'is_deleted', 'is_warehouser', 'in_out_enable', 'is_capture', 'one_time_sales', 'created_by', 'updated_by', 'bank_ledger_id'];
