                        ...
                        @php
                            ...
                            if ($invoice->branch_id == 1) {
                                if ($invoice->party_user_id) {
                                    $partyDiscount = optional($partyPrices->where('product_id', $product->id)->first())
                                        ->cust_discount_price;
                                } else {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="qty-wrapper">
                                    ...
                                    <input type="number" name="items[{{ $i }}][quantity]" class="qty-input"
                                        value="{{ $item['quantity'] }}" data-price="{{ $basePrice }}"
                        ...
                        <div id="payment-fields">
                            <div id="cash-field" class="payment-input">
                                ...
                                <input type="number" id="cash-amount" class="form-control" min="0"
                                    step="1" readonly name="cash_amount" value="{{ $invoice->cash_amount }}">
                            </div>
