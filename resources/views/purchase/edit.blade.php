                        ...
                        <div class="card">
                            <div class="card-header d-flex justify-content-between">
                                <div class="header-title">
                                    <h4 class="card-title">Edit Purchase Invoice</h4>
                                </div>
                                <div>
                                                    ...
                                                    <select name="vendor_id" id="vendor_id" class="form-control">
                                                        ...
                                                        @foreach ($vendors as $vendor)
                                                            <option value="{{ $vendor->id }}"
                                                                @selected(old('vendor_id', $purchase->vendor_id) == $vendor->id)>
                                                                {{ $vendor->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="vendor_new_id" id="vendor_new_id" class="form-control">
                                                        ...
                                                        @foreach ($ledgersAll as $vendor)
                                                            <option value="{{ $vendor->id }}"
                                                                @selected(old('vendor_new_id', $purchase->vendor_new_id) == $vendor->id)>
                                                                {{ $vendor->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-md-4">
                                                    ...
                                                    <select name="parchase_ledger" id="parchase_ledger"
                                                        ...
                                                        @foreach ($ledgers as $ven)
                                                            <option value="{{ $ven->id }}"
                                                                @selected(old('parchase_ledger', $purchase->parchase_ledger) == $ven->id)>
                                                                {{ $ven->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                    ...
                                                    <select name="subcategories" id="subcategories" class="form-control">
                                                        ...
                                                        @foreach ($subcategories as $subcat)
                                                            <option value="{{ $subcat->id }}"
                                                                data-id="{{ $subcat->id }}" @selected(old('subcategories', $purchaseProducts[0]['subcategory_id'] ?? '') == $subcat->id)>
                                                                {{ $subcat->name }}
                                                            </option>
                                                        @endforeach
                                                    </select>
                                                        ...
                                                        <div
                                                            ...
                                                            <div>
                                                                ...
                                                                <h3 class="text-primary" id="excise_total_amount">
                                                                    ₹{{ number_format(old('excise_total_amount', $purchase->excise_total_amount), 2) }}
                                                                </h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="p-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <h3 id="total_amount">
                                                                        ₹{{ number_format(old('total_amount', $purchase->total_amount), 2) }}
                                                                    </h3>
                                                                </div>
                                                            </div>
            ...
            <script>
                ...
                document.addEventListener('DOMContentLoaded', function() {
                    ...
                    if (vendorId) {
                        ...
                        if (exciseTotal) {
                            $('#excise_total_amount').text('₹' + parseFloat(exciseTotal).toFixed(2));
                            $('.excise_total_amount').val(parseFloat(exciseTotal).toFixed(2));
                        }
