        ...
        <div class="col-sm-12">
          <div class="card">
            <div class="card-header d-flex justify-content-between">
              <div class="header-title"><h4 class="card-title">Create Ledger</h4></div>
              <div><a href="{{ route('accounting.ledgers.list') }}" class="btn btn-secondary">Back</a></div>
            </div>
              ...
              <form action="{{ route('accounting.ledgers.store') }}" method="POST">
                ...
                <div class="row g-3">
                  ...
                  <div class="col-md-2">
                    ...
                    <input type="checkbox" name="is_active" value="1" {{ old('is_active',1) ? 'checked':'' }}> Yes
                  </div>
                </div>
