                                    ...
                                    <ul class="nav nav-pills mb-3 nav-fill" role="tablist">
                                        <li class="nav-item">
                                            <a href="#" wire:click.prevent="setCategory('IMFL')"
                                                ...
                                                <span
                                                    class="fs-6 {{ $selectedCategory == 'IMFL' ? 'text-white' : 'text-dark' }}">IMFL</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#" wire:click.prevent="setCategory('BEER')"
                                                ...
                                                <span
                                                    class="fs-6 {{ $selectedCategory == 'BEER' ? 'text-white' : 'text-dark' }}">BEER</span>
                                            </a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="#" wire:click.prevent="setCategory('CL_RML')"
                                                ...
                                                <span
                                                    class="fs-6 {{ $selectedCategory == 'CL_RML' ? 'text-white' : 'text-dark' }}">CL
                                                    &amp; RML</span>
                                            </a>
                                        </li>
                                    </ul>
                                                ...
                                                <table class="table table-bordered physical-table mb-0">
                                                    ...
                                                    <tbody>
                                                        @foreach ($this->addstockStatus as $product)
                                                            <tr>
                                                                <td class="border">{{ $product['product']['name'] }}
                                                                </td>
                                                                <td class="border">{{ $product['opening_stock'] }}
                                                                </td>
                                                                <td class="border">{{ $product['sold_stock'] }}</td>
                                                                <td class="border">
                                                                    <input type="number"
                                                                        wire:key="warehouse-product-{{ $product['product_id'] }}"
                                                                        wire:model.live="products.{{ $product['product_id'] }}.qty"
                                                ...
                                                <table class="table table-bordered physical-table mb-0 sticky-table">
                                                    <thead class="table-info">
                                                        ...
                                                        <tr>
                                                            <th rowspan="2" class="align-center"
                                                                style="min-width: 250px;max-width: 400px">Product Name
                                                            </th>
                                                            @foreach ($sizes as $size)
                                                                <th colspan="3" class="text-center size-divider">
                                                                    {{ $size }}</th>
                                                            @endforeach
                                                        </tr>
                                                        <tr>
                                                    ...
                                                    <tbody>
                                                        @foreach ($groupedProducts as $product)
                                                            <tr
                                                                wire:key="row-{{ $selectedCategory }}-{{ $product['name'] }}">
                                                                <td>{{ $product['name'] }}</td>
                                                                ...
                                                                @foreach ($sizes as $size)
                                                                    ...
                                                                    @else
                                                                        ...
                                                                        <td class="text-center text-muted">-</td>
                                                                        <td
                                                                            class="text-center text-muted size-divider">
                                                                            -</td>
                                                                    @endif
                                                                @endforeach
                                                            </tr>
