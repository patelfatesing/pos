                                        ...
                                        <div class="card-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3">
                                                    ...
                                                    <h6 class="text-start close-text">{{ $this->currentShift->start_time ?? '-' }}</h6>
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-xl">
                <div class="modal-content shadow rounded-3">
                    ...
                    <div class="modal-header custom-modal-header">
                        ...
                        <button type="button" class="close btn btn-default" wire:click="$set('showStockModal', false)">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
            ...
            <div class="modal-dialog modal-dialog-scrollable modal-lg">
                <div class="modal-content shadow rounded-3">
                    ...
                    <div class="modal-header custom-modal-header text-white">
                        ...
                        <button type="button" class="close btn btn-default" wire:click="$set('showPhysicalModal', false)">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer flex-column align-items-stretch gap-3">
                        ...
                        <div class="d-flex justify-content-end gap-2 w-100">
                            <button type="submit" form="stockPhysicalForm" class="btn btn-default submit-btn  rounded-pill">
                                <i class="bi bi-save"></i> Save
                            </button>
                            <button class="btn btn-outline-secondary rounded-pill" wire:click="closePhyStockModal">
