                                    ...
                                    <table class=" table table-bordered ">
                                        ...
                                        <tbody>
                                            @foreach ($noteDenominations as $key => $denomination)
                                                ...
                                                @endphp
                                                <tr>
                                                    <td class="text-center">{{ format_inr($inValue * $denomination) }}
                                                    </td>
                                                    ...
                                                    <td class="text-center">{{ format_inr($outValue * $denomination) }}
                                                    </td>
                                                </tr>
                                            @endforeach
                            ...
                            <div class="col-12 bg-light shadow-sm">
                                <div class="row align-items-center px-2 py-3 rounded">
                                    ...
                                    <div class="col-md-5 text-end">
                                        ...
                                        <span
                                            class="fw-bold text-success fs-5 ms-2">{{ $this->totalCollected }}</span>
                                    </div>
                                </div>
                            </div>
                        </div>
