                        ...
                        <table class="table table-striped table-bordered nowrap">
                            ...
                            <tbody>
                                ...
                                @forelse ($rawStockData as $stock)
                                    ...
                                    <tr
                                        class="{{ $stock->difference_in_stock != 0 ? 'highlight-diff' : '' }} {{ $stock->edit_data == 'yes' ? 'edited-input' : '' }}">
                                        <td>{{ $sr++ }}</td>
                                        ...
                                        <td>
                                            <input type="number" class="form-control form-control-sm physical-input"
                                                {{ $shift->status == 'pending' ? 'disabled' : '' }}
                                                value="{{ $stock->physical_stock }}"
                                                data-product-id="{{ $stock->product_id }}"
                                                data-stock-id="{{ $stock->id }}" style="width:90px; text-align:center;">
                                        </td>
