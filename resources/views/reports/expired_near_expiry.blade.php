...
<style>
    ...
    .custom-toolbar-row .status-filter { order: 3; }
    .custom-toolbar-row .days-filter { order: 3; } /* next to status */
    .custom-toolbar-row .dataTables_filter { order: 4; margin-left: auto; }
    .dataTables_wrapper .dataTables_filter label,
    .dataTables_wrapper .dataTables_length label { display: flex; align-items: center; gap: 5px; margin-bottom: 0; }
            ...
            <div class="row align-items-center mb-3">
                <div class="col-lg-12">
                    <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                        <div><h4 class="mb-3">Expired / Near Expiry Products</h4></div>
                    </div>
                </div>
            </div>
...
$(function () {
    ...
    const table = $('#expiry_table').DataTable({
        ...
        initComplete: function() {
            ...
            $('#type, #days, #branch_id, #category_id, #sub_category_id').on('change keyup', function() {
                table.ajax.reload();
            });
        }
    });
