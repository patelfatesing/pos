                    ...
                    <div class="card-header d-flex flex-wrap align-items-center justify-content-between">
                        ...
                        <div>
                            @if ($branch_id != '' && $shift_id != '')
                                <a href="{{ route('stock-transfer.craete-transfer') }}?branch_id={{ $branch_id }}&shift_id={{ $shift_id }}&type={{ $type }}"
                                    class="btn btn-success">
                                    <i class="fas fa-plus"></i> New Transfer
                                </a>
                            @else
                                <a href="{{ route('stock-transfer.craete-transfer') }}" class="btn btn-success">
                                    <i class="fas fa-plus"></i> New Transfer
                                </a>
                            @endif
                        </div>
