<div class="card">
    <div class="card-body">
        ...
        <!-- FORM -->
        <form id="editTransferForm" action="{{ route('stock-transfer.update', $transfer->id) }}" method="POST">
            @csrf
            ...
            <div class="row">
                ...
                <div class="col-md-6 mt-2">
                    ...
                    <select id="sub_category_ids" name="subcategory_id" class="form-control">
                        ...
                        @php
                            $subs = \App\Models\SubCategory::where('category_id', $transfer->category_id)->get();
                        @endphp
