            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        ...
                        @foreach($data['best_selling_product'] as $product)
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    <div class="">
                                        ...
                                        <h5>$ {{ number_format($data['total_financial_year_income'], 0, '.', ',') }} K</h5>
                                    </div>
                                </div>
                            ...
                            <div class="card-body">
                                <div class="d-flex align-items-top justify-content-between">
                                    <div class="">
                                        ...
                                        <h5>$ {{ number_format($data['total_financial_year_expenses'], 0, '.', ',') }} K</h5>
                                    </div>
                                </div>
    ...
    <script defer>
        ...
        const salesQuantityByMonth = @json($data['sales_quantity_by_month']);
        const purchaseQuantityByMonth = @json($data['purchase_quantity_by_month']);
        const salesAmountTotal = @json($data['sales_amount_total']);
        const financialYearIncome = @json($data['financial_year_income']);
        const financialYearExpenses = @json($data['financial_year_expenses']);
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            let options2 = {
                ...
                title: {
                    text: 'Purchase Quantity by Month',
                    align: 'left'
                },
                grid: {
                    row: {
            ...
            const el3 = document.getElementById('apex-bar');
            if (!el3) return; // Chart container not on this page
            ...
            const chart3 = new ApexCharts(el3, options3);
            chart3.render();

            const body3 = document.body;
            if (body3.classList.contains('dark') && typeof window.apexChartUpdate === 'function') {
                window.apexChartUpdate(chart3, {
                    dark: true
                });
            }
            ...
            document.addEventListener('ChangeColorMode', function(e) {
                if (typeof window.apexChartUpdate === 'function') {
                    window.apexChartUpdate(chart3, e.detail);
                }
            });

            const el4 = document.getElementById('layout1-chart-3');
            if (!el4) return; // Chart container not on this page
            ...
            const chart4 = new ApexCharts(el4, options4);
            chart4.render();

            const body4 = document.body;
            if (body4.classList.contains('dark') && typeof window.apexChartUpdate === 'function') {
                window.apexChartUpdate(chart4, {
                    dark: true
                });
            }
            ...
            document.addEventListener('ChangeColorMode', function(e) {
                if (typeof window.apexChartUpdate === 'function') {
                    window.apexChartUpdate(chart4, e.detail);
                }
            });

            const el5 = document.getElementById('layout1-chart-4');
            if (!el5) return; 
            ...
            const chart5 = new ApexCharts(el5, options5);
            chart5.render();

            const body5 = document.body;
            if (body5.classList.contains('dark') && typeof window.apexChartUpdate === 'function') {
                window.apexChartUpdate(chart5, {
                    dark: true
                });
            }
            ...
            document.addEventListener('ChangeColorMode', function(e) {
                if (typeof window.apexChartUpdate === 'function') {
                    window.apexChartUpdate(chart5, e.detail);
                }
            });
        });
    </script>