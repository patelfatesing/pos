                    ...
                    <div class="verify-box d-flex justify-content-around align-items-center">
                        ...
                        <div class="verify-item text-center">
                            ...
                            <label class="verify-checkbox">
                                <input type="checkbox" id="modal_sales" onchange="handleModalChange('sales', this)">

                                <div class="verify-single-btn unverified">
                        ...
                        <div class="verify-item text-center">
                            ...
                            <label class="verify-checkbox">
                                <input type="checkbox" id="modal_transfer" onchange="handleModalChange('transfer', this)">
                        ...
                        <div class="verify-item text-center">
                            ...
                            <label class="verify-checkbox">
                                <input type="checkbox" id="modal_shift" onchange="handleModalChange('shift', this)">
...
@section('scripts')
    <script>
        $(document).on('click', '.store-row td:nth-child(1), .store-row td:nth-child(2)', function(e) {
            ...
            if ($(e.target).closest('.verify-single-btn').length) {
                return;
            }
        ...
        function changeVerifyStatus(type, shift_id, isChecked, role, checkbox, oldValue) {
        ...
        function verifyFullShift(shift_id, isChecked, role, checkbox, oldValue) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            Swal.fire("Done!", "Shift updated", "success");
                        }
                    });
        ...
        function openCreateTransfer() {
            ...
            var shiftId = $('#shift_id_1').val();
            var branchId = $('#shift_date').val();
        ...
        function handleModalChange(type, checkbox) {
            ...
            if (type === 'shift') {
                ...
                changeVerifyStatus(type, currentShiftId, checkbox.checked, 'sub_admin', checkbox, oldValue);
            }
        }

        function handleVerifyChange(checkbox, type, shiftId, role) {
            ...
            if (type === 'shift') {
                ...
                verifyFullShift(shiftId, isChecked, role, checkbox, oldValue);

            } else {

                changeVerifyStatus(type, shiftId, isChecked, role, checkbox, oldValue);
            }
        }

        function handleShiftChange(checkbox, shiftId, role) {
            ...
            // call API with rollback support
            verifyFullShift(shiftId, isChecked, role, checkbox, oldValue);
        }

        function triggerVerifyBtn(event, el) {

            event.preventDefault();
            event.stopPropagation();
            event.stopImmediatePropagation();

            let checkbox = el.closest('.verify-checkbox').querySelector('input');
        ...
        function updateVerifyUI(checkbox) {

            let btn = checkbox.nextElementSibling;
            ...
            if (checkbox.checked) {
                ...
                btn.querySelector('.icon').innerText = '✖';
                btn.querySelector('.text').innerText = 'UNVERIFIED';
            }
        }
    </script>
@endsection
