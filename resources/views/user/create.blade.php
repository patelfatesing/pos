                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="floating-label form-group">
                                            ...
                                            <input id="password" class="floating-input form-control pr-5" name="password"
                                                type="password" placeholder=" " :value="old('password')">
                                            <!-- Eye icon -->
                                            <span class="position-absolute" style="top: 50px; right: 15px; cursor: pointer;"
                                    ...
                                    <div class="col-lg-4">
                                        <div class="floating-label form-group">
                                            ...
                                            <input class="floating-input form-control" value="{{ old('phone_number') }}"
                                                name="phone_number" type="tel" placeholder=" " autocomplete="tel">
                                            @error('phone_number')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-4 branch-section">
                                        <div class="form-group">
                                            ...
                                            <select name="branch_id" class="selectpicker form-control" data-style="py-0">
