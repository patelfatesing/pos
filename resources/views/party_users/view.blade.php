                                ...
                                <div class="tab-content" id="pills-tabContent-1">
                                    ...
                                    <div class="tab-pane fade" id="pills-profile-fill" role="tabpanel"
                                        ...
                                        <div class="table-responsive rounded mb-3">
                                            <table class="table table-striped" id="cust_party_his_table">
                                    ...
                                    <div class="tab-pane fade" id="pills-contact-fill" role="tabpanel"
                                        ...
                                        <div class="table-responsive rounded mb-3">
                                            <table class="table table-striped" id="credit_history_table">
...
<script>
    $(document).ready(function() {
        ...
        const customer_id = @json($partyUser->id);
        ...
        // ================= CLICK EVENT (NOT bootstrap event) =================
        $('#pills-profile-tab-fill').on('click', function() {

            console.log("Transaction Tab Clicked");

            if (!transactionTable) {

                transactionTable = $('#cust_party_his_table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
                    ...
                    columns: [{
                        ...
                        onclick="showPhoto(${row.transaction_id})"
        ...
        $('#pills-contact-tab-fill').on('click', function() {

            console.log("Credit Tab Clicked");

            if (!creditTable) {

                creditTable = $('#credit_history_table').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: {
